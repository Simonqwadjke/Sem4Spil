...
public class MapUtil {
	...
	public static Vector3 posV3(Location location) {
    ...
    public static Vector3 posV3(float x, float y) {
    ...
    public static Location posLoc(Vector3 v3) {
		return new Location() {
			X = v3.x -2,
			Y = v3.y
		};
    ...
    public static Location posLoc(float x, float y) {
    ...
    public static Location Convert(Vector3 v3) {
		return new Location() {
			X = v3.x,
			Y = v3.y
		};
    ...
    public static Vector3 Convert(Location location) {
		return new Vector3(location.X, location.Y);
	}

    public static Vector3 Convert(Size size)
    {
        return new Vector3(size.Width, size.Height);
    }
    ...
    public static GameObject CreateComponent(Sprite sp, Vector3 position, String objectName, Transform parrent = null, string layer = "Default", string tag = "Untagged") {
